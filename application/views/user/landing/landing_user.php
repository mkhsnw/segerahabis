...
<body class="w-full">
    <div class="overflow-auto flex flex-col w-3/4 mx-auto py-20 px-10 bg-cover bg-center rounded-xl mt-6 gap-6 bg-[url('<?php echo base_url('assets/image/landing/Landingpage_User_Banner_01.png')?>')]">
        <h1 class="hemat font-semibold text-6xl text-white w-3/4 tracking-wide">
    ...
    <div class="w-3/4 flex flex-row grid grid-cols-2 gap-4 mx-auto py-20">
        <img class="sm:w-6/12 lg:w-11/12 aspect-video bg-red-900 rounded-xl object-cover object-center" src="<?php echo base_url('assets/image/landing/FoodWaste_02.png')?>" alt="image description">
