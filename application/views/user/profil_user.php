                    ...
                    <div class="flex flex-row justify-between">
                        <div class="flex flex-col gap-4 w-full">
                            ...
                            <div>
                                ...
                                <input type="email" value="dananagdwimaryanto@email.com" class="ml-5 mt-1 block w-10/12 border border-gray-300 rounded-md
                                 shadow-sm p-2">
                            </div>
                            <div>
                                <label class="ml-5 block text-sm font-bold text-gray-700">No. HP</label>
                                <input type="text" value="0123 4567 8910" class="ml-5 mt-1 block w-10/12 border border-gray-300 rounded-md shadow-sm p-2">
                            </div>
