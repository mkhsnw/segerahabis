                        ...
                        <div class="w-full flex flex-row justify-between items-center">
                            <div class="w-full flex flex-col">
                                ...
                                <div class="flex flex-row items-start mb-2 gap-1">
                                    ...
                                    <p class="text-black font-bold text-sm">Danang</p>
                                    <p class="text-black font-small text-sm">|</p>
                                    <p class="text-black font-small text-sm text-gray-600">0123 456 78910</p>
                                </div>
                                <p class="text-black font-small text-sm text-gray-600 w-4/5 mb-2">
                                    Gentan RT 08 / RW 04, Gentan, Gantiwarno, Klaten, Gantiwarno, Kabupaten Klaten, Jawa Tengah, 57455, Gantiwarno, Kab. Klaten, Jawa Tengah,
                                </p>
                            </div>
                    ...
                    <div class="w-full px-4 py-2 ">
                        ...
                        <div class="w-full flex flex-col mt-1">
                            <div class="w-full flex flex-row gap-2 items-center">
                                ...
                                <p class="text-black font-bold text-lg">Nama Toko Penjual</p>
                            </div>
                ...
                <div class="flex flex-col">
                    ...
                    <ul class="w-full text-sm font-medium text-gray-900 bg-white border-2 border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white mb-2">
                        <div class="w-full px-8 py-2 flex flex-col">
                            ...
                            <a href="<?php echo site_url('user/daftar_user'); ?>" class="mt-4 mb-4 text-sm text-center font-medium text-white bg-green-600 border border-blue-700 rounded-lg px-4 py-2 hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-green-700 dark:hover:bg-green-800 dark:focus:ring-blue-800">
                                Bayar</a>
