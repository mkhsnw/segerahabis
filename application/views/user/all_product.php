...
<body class="w-full">
    <div class="w-4/5 flex md:items-start mx-auto">
        <div class="p-4">
        ...
        <div class="p-4">
            ...
            <div class="flex flex-row md:justify-between mb-4">


                <div class=" flex items-center mb-4">
                    <p class="text-black font-medium text-lg">Hasil Pencarian</p>
                    <p class="text-black font-bold text-lg">"Nama Produk"</p>
                </div>

                <button id="dropdownDefaultButton" data-dropdown-toggle="price" class="md:w-50 md:h-10 text-black bg-gray-200 hover:bg-gray-300 focus:ring-2 focus:outline-gray-200 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-gray-600 dark:hover:bg-gray-600 dark:focus:ring-gray-600" type="button">Harga Terendah <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                    </svg>
                </button>
                <div id="price" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200 border border-bg-gray-300 rounded shadow-s" aria-labelledby="dropdownDefaultButton">
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-gray-300 dark:hover:bg-gray-700 dark:hover:text-black">Diskon Besar</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="flex flex-col md:items-center">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between space-x-6 mb-4">
