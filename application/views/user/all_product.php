    ...
    <div class="w-4/5 flex md:items-start mx-auto tracking-tight">
        ...
        <div class="p-4 grow">
            ...
            <div class="flex flex-row md:justify-between mb-4">
                <div class=" flex items-center mb-4">
                    <p class="text-black font-medium text-lg tracking-tight">Hasil Pencarian</p>
                    <p class="text-black font-bold text-lg tracking-tight">"<?php echo $search?>"</p>
                </div>
            ...
            <div class="flex flex-col md:items-center w-full">
                <div class="flex flex-row grid sm:grid-cols-2 md:grid-cols-3 md:flex-row md:items-center md:justify-between gap-5 mb-4 ">
                    ...
                    <div class="max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="rounded-t-lg" src="<?php echo base_url('assets/foto_produk/'.$p->foto_Produk) ?>" alt="" />
                        </a>
                        <div class="p-5">
                            <a href="#">
                                <h5 class="mb-2 text-sm font-medium tracking-tight text-gray-900 dark:text-white"><?php echo $p->nama_Produk;?></h5>
                            </a>
                            <p class=" text-xl font-bold tracking-tight text-gray-900 dark:text-white">Rp. <?php echo $p->hargaDiskon?></p>
                            <div class="flex items-center space-x-2 mb-2">
                                <p class="mb-0 text-sm font-bold tracking-tight text-gray-400 dark:text-gray-400 line-through">Rp. <?php echo $p->harga?></p>
                                <p class="text-sm font-bold text-red-500"><?php echo $p->diskon?>%</p>
                            </div>
                            <div class="flex items-center space-x-2 mb-1">
                                ...
                                <h1 class="font-semibold text-xs tracking-tight text-gray-500 dark:text-gray-500" style="font-family: 'Inter', sans-serif;"><?php echo $p->sisaHari?> Hari lagi | 1rb+ Terjual</h1>
                            </div>
                        </div>
                    </div>
                        <?php }?>
