...
<body class="w-full">
    ...
    <div class="w-4/5 flex flex-col md:items-start mx-auto">
        <p class="text-black mr-4 md:mr-8 font-bold text-lg mb-2 mt-4">Keranjang</p>
                ...
                <ul class="w-full text-sm font-medium text-gray-900 bg-white border-2 border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white mb-2">
                    <div class="w-full px-4 py-2">
                        <div class="flex flex-row items-center mb-2 gap-6 px-6 py-3">
                            ...
                            <p class="text-black mr-4 md:mr-8 font-bold text-lg">Rp. 20.000</p>
                        </div>
                    </div>
                </ul>
                ...
                <ul class="w-full text-sm font-medium text-gray-900 bg-white border-2 border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white mb-2">
                    <div class="w-full px-8 py-2 flex flex-col">
                        ...
                        <div class="flex flex-row justify-between mb-4 ">
                            ...
                            <p class="text-black font-md text-md ">Rp. 284.000</p>
                        </div>
                        <p class="border-2 border-t border-bg-black"></p>
                        <a href="<?php echo site_url('user/daftar_user'); ?>" class="mt-4 mb-4 text-sm text-center font-medium text-white bg-green-800 border border-blue-700 rounded-lg px-4 py-2 hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-green-700 dark:hover:bg-green-800 dark:focus:ring-blue-800">
                                Beli (21)</a>
                    </div>
                </ul>
            </div>
