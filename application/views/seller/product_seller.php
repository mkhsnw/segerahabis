...
<body class="bg-gray-100">
    ...
    <div class="flex flex-row w-full mx-auto">
        ...
        <aside id="default-sidebar" class="flex-col left-0 z-10 md:w-64 sm:w-20 h-screen sticky" aria-label="Sidebar">
                            ...
                            <div class="flex flex-row w-full gap-2 justify-between mb-2 overflow-auto py-2">
                                ...
                                <form class="w-1/2">
                                    <div class="flex">
                                        <div class="relative w-full tracking-wide">
                                            <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-white-200 rounded-lg  border-1 border border-gray-300 focus:ring-white-200 focus:border-white-500 dark:bg-white-700 dark:border-s-white-700  dark:border-black-600 dark:placeholder-gray-400 dark:text-black dark:focus:border-white" placeholder="
                                            Cari Produk" required />
                                ...
                                <div class="flex flex-row gap-3 items-center h-auto">
                                    ...
                                    <div>
                                        ...
                                        <!-- Dropdown kategori -->
                                        <div id="kategori" class="z-2  hidden bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 w-auto border-2 border-bg-gray-400">
                                    ...
                                    <div>
                                        ...
                                        <div id="kadaluwarsa_seller" class="z-2  hidden bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 w-auto border-2 border-bg-gray-400">
                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                                                <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-black">
                                                    <div class="flex items-center">
                                                        <input id="kadaluwarsa_seller1" type="radio" value="" name="default-radio" class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                        <label for="" class="ms-2 text-xs font-small text-gray-700 dark:text-gray-700">7 Hari lagi</label>
                                                    </div>
                                                </li>
                                                <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-black">
                                                    <div class="flex items-center">
                                                        <input id="kadaluwarsa_seller2" type="radio" value="" name="default-radio" class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                        <label for="" class="ms-2 text-xs font-small text-gray-700 dark:text-gray-700">14 Hari lagi</label>
                                                    </div>
                                                </li>
                                                <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-black">
                                                    <div class="flex items-center">
                                                        <input id="kadaluwarsa_seller3" type="radio" value="" name="default-radio" class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                        <label for="" class="ms-2 text-xs font-small text-gray-700 dark:text-gray-700">21 Hari lagi</label>
                                                    </div>
                                                </li>
                                                <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-black">
                                                    <div class="flex items-center">
                                                        <input id="kadaluwarsa_seller4" type="radio" value="" name="default-radio" class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                        <label for="" class="ms-2 text-xs font-small text-gray-700 dark:text-gray-700">30 Hari lagi</label>
                                                    </div>
                                                </li>
                                                <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-black">
                                                    <div class="flex items-center">
                                                        <input id="kadaluwarsa_seller5" type="radio" value="" name="default-radio" class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                        <label for="" class="ms-2 text-xs font-small text-gray-700 dark:text-gray-700">60 Hari lagi</label>
                                                    </div>
                                                </li>
                                                <li class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-black">
                                                    <div class="flex items-center">
                                                        <input id="kadaluwarsa_seller6" type="radio" value="" name="default-radio" class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    ...
                                    <tbody>
                                        <tr class="border-b-2 border-bg-black">
                                            ...
                                            <td class="px-3 py-5 ">
                                                ...
                                                <a href="#">
                                                    <div class="flex bg-white gap-1 items-center border border-red-800 rounded-lg px-4 py-2 hover:bg-red-200 
                                                    ...
                                                    dark:focus:ring-red-800">
                                                        ...
                                                        <h1 class="text-sm font-medium text-red-800">Hapus</h1>
                                                    </div>
                                                </a>
                                            </td>
                                        </tr>
