      ...
      <div class="w-full bg-white-50 rounded-lg shadow-xl dark:border md:mt-0 sm:max-w-sm xl:p-0 dark:bg-white dark:border-gray-150">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <div class="leading-tight tracking-tight text-gray-900 dark:text-black text-center">
                    ...
                    <p class="text-sm">Sudah punya akun Segerahabis? <a href="<?php echo site_url('seller/login_seller'); ?>" class="text-green-600">Masuk</a></p>
                  </div>
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div>
                        <input type="text" name="namatoko" id="namatoko" class="bg-gray-50 border border-gray-150 text-black-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-white-700 dark:border-gray-300 dark:placeholder-gray-150 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nama Toko" required="">
                    </div>
                    <div>
