...
<body class="w-full">
    <div class="overflow-auto flex flex-col w-3/4 mx-auto py-20 px-10 rounded-xl mt-6 gap-6 bg-cover bg-center bg-[url('https://png.pngtree.com/thumb_back/fh260/background/20210426/pngtree-abstract-gradient-crystal-texure-background-in-dark-green-color-image_671444.jpg')]">
        <h1 class="font-semibold text-6xl text-white w-10/12 tracking-wide">
        ...
        <a href="<?php echo site_url('user/daftar'); ?>" class="text-sm font-medium text-white bg-green-600 rounded-lg px-3 py-2 hover:bg-green-900 w-60 text-center">
    ...
    <div class="w-3/4 flex flex-row grid grid-cols-2 gap-4 mx-auto py-20">
        <img class="gambar-1 h-full aspect-auto object-cover object-center bg-gray-500 rounded-xl" src="https://images.pexels.com/photos/958545/pexels-photo-958545.jpeg?cs=srgb&dl=pexels-chanwalrus-958545.jpg&fm=jpg" alt="image description">
    ...
    <div class="w-full bg-green-50 py-20">
        <div class="w-4/12 mx-auto justify-center text-center">
    ...
    <div class="w-3/4 mx-auto py-20 ">
        ...
        <div class="flex flex-row grid md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-4 mt-10 gap-2">
            <div class="flex flex-col items-center">
                <img class="mt-6 w-24 rounded-xl aspect-square object-cover object-center" src="https://images.pexels.com/photos/958545/pexels-photo-958545.jpeg?cs=srgb&dl=pexels-chanwalrus-958545.jpg&fm=jpg" alt="image description">
    ...
    <div class="w-full bg-green-600 py-20 mb-20">
        <div class="flex flex-col w-3/4 mx-auto justify-center items-center text-center gap-10">
            ...
            <a href="<?php echo site_url('seller/daftar_seller'); ?>" class="text-sm font-medium text-white bg-yellow-400 rounded-lg px-12 py-2 hover:bg-yellow-500 w-60 text-center justify-center">
                Jualan Sekarang
            </a>
        </div>
    </div>
