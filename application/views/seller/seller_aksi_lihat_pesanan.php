...
<body class="w-full">
    ...
    <div class="mb-10 bg-white py-8 rounded-lg w-2/5 mx-auto">
        ...
        <div class="flex gap-6 mt-4">
            ...
            <a href="<?php echo site_url('seller/seller_pesanan'); ?>" class="flex-1 text-sm text-center font-medium text-white bg-green-800 border border-blue-700 rounded-lg px-4 py-2 hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-green-700 dark:hover:bg-green-800 dark:focus:ring-green-800">Terima Orderan</a>
        </div>
    </div>
