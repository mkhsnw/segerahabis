        ...
        <aside id="default-sidebar" class="flex-col left-0 z-10 xs:invisible md:visible md:w-64 h-screen sticky" aria-label="Sidebar">
            <div class="h-full px-3 py-4 bg-white dark:bg-white border-r-2 border-bg-gray-600 shadow shadow-lg">
                <ul class="space-y-0 font-medium">
                    ...
                    <li>
                        <a href="<?php echo site_url('seller/seller_pesanan'); ?>" aria-current="page" class="flex text-lg font-bold items-center p-2 text-green-700 rounded-lg dark:text-green-700 group">
                            <svg xmlns=" http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                                ...
                                                <div id="aksi<?php echo $no ?>" class="z-2  hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-auto border-2 border-bg-gray-400">
                                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200 items-center" aria-labelledby="dropdownDefaultButton">
                                                        ...
                                                        <?php } elseif ($val->status_Order == 'Pesanan Baru') { ?>
                                                            ...
                                                            <li class="block px-2 py-2">
                                                                <div class="flex justify-center items-center text-center">
                                                                    <a href="<?php echo site_url('seller/tolak_order/' . $val->id_Order) ?>" class="flex block items-center justify-center gap-2 text-center hover:text-red-600 ms-2 text-xs font-small text-gray-700">
                                                                        <span>
