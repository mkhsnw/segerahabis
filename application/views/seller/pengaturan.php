...
<body>
    <div class="flex flex-row w-full mx-auto items-start bg-gray-100 overflow-auto">
        ...
        <div class="flex flex-col h-screen w-full px-6 py-8 bg-gray-100 overflow-auto">
            <p class="text-black font-bold text-xl mb-8">Pengaturan Toko</p>
            <!-- Profile Form -->
                        ...
                        <div class="flex flex-row justify-between">
                            <div class="flex flex-col gap-4 w-full">
                                ...
                                <div class>
                                    ...
                                    <textarea class="ml-5 mt-1 block w-10/12 border border-gray-300 rounded-md shadow-sm p-2 h-40" name="deskripsi" placeholder="Tuliskan Deskripsi Produk Disini"></textarea>
                                </div>
         ...
         $(document).ready(function() {
            ...
            $('#closeModalButton, #continueButton').click(function() {
                ...
                if (this.id == 'continueButton') {
                    window.location.href = '<?php echo site_url('seller/p'); ?>';
                }
            });
        });
