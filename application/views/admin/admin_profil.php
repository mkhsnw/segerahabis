...
<body>
    ...
    <div class="flex flex-row w-full mx-auto items-start bg-gray-100 overflow-auto">
                    ...
                    <ul class="space-y-0 font-medium">
                        <li>
                            ...
                            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                <path stroke="darkgreen" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0 0a8.949 8.949 0 0 0 4.951-1.488A3.987 3.987 0 0 0 13 16h-2a3.987 3.987 0 0 0-3.951 3.512A8.948 8.948 0 0 0 12 21Zm3-11a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
                            </svg>
        ...
        <div class="flex flex-col h-screen w-full px-6 py-8 bg-gray-100 overflow-auto">
            <p class="text-black font-bold text-xl mb-8">Profil Admin</p>

            <div class="flex-col mb-5 grow bg-white border-2 border-bg-black rounded-lg shadow-lg">
            <h2 class="ml-5 mt-7 text-2xl font-bold">Profil Admin</h2>
            ...
            <form>
                <div class="flex flex-col gap-6 w-full">
                    <div class="w-full">
                        ...
                        <input type="text" value="Admin Selot" class="ml-5 mt-1 block w-11/12 border border-gray-300 rounded-md shadow-sm p-2">
                    </div>
                    <div class="w-full">
                        <label class="ml-5 block text-sm font-bold text-gray-700">Email</label>
                        <input type="email" value="adminslot@mail.com" class="ml-5 mt-1 block w-11/12 border border-gray-300 rounded-md shadow-sm p-2">
                    </div>
                </div>
                    ...
                    <div id="successModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                            ...
                            <div class="relative px-2 py-8 text-center bg-white rounded-lg shadow">
                                ...
                                <p class="mb-4 text-lg font-bold text-gray-900 dark:text-white">Berhasil Mengganti Profil Admin</p>
        ...
        <div class="flex-col grow bg-white border-2 border-bg-black rounded-lg shadow-lg">
            <h2 class="ml-5 mt-7 text-2xl font-bold">Password Admin</h2>
            <hr class="mt-4 h-px my-5 bg-gray-200 border-0 dark:bg-gray-700">
            <form>
                <div class="flex flex-col gap-6 w-full">
                    <div class="w-full">
                    ...
                    <div id="successModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                            ...
                            <div class="relative px-2 py-8 text-center bg-white rounded-lg shadow">
                                ...
                                <p class="mb-4 text-lg font-bold text-gray-900 dark:text-white">Berhasil Mengganti Password Admin</p>
                                <button data-modal-toggle="successModal" type="button" class="py-2 px-3 text-sm font-medium text-center 
                                            text-white rounded-lg bg-green-600 hover:bg-green-700">
                                    Lanjutkan
                                </button>
