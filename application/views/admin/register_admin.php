...
<html lang="en">
    ...
    <body class="w-full">
        ...
        <div class="flex flex-col items-center justify-center  mx-auto">
            <a href="#" class="flex items-center text-2xl font-semibold text-gray-900 dark:text-white py-8">
      ...
      <div class="w-full bg-white-50 rounded-lg shadow-xl dark:border md:mt-0 sm:max-w-sm xl:p-0 dark:bg-white dark:border-gray-150">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <div class="leading-tight tracking-tight text-gray-900 dark:text-black text-center">
                    ...
                    <p class="text-sm">Sudah punya akun Segerahabis Admin? <a href="<?php echo site_url('admin/login_admin'); ?>" class="text-green-600">Masuk</a></p>
                  </div>
