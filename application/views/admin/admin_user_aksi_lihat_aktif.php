...
<body class="w-full">
    ...
    <div class="mb-3 flex flex-row w-full">
        ...
        <div class="ml-5">
            <h1 class="text-2xl font-bold mt-3">Pak Danang</h1>
        ...
        <div class="flex flex-row w-full gap-10">
            ...
            <div class="w-1/2">
                <div class="flex flex-col mx-auto py-2">
                    <p class="text-sm font-bold">Nama Lengkap</p>
                    <p class="text-sm font-normal">Pak Danang</p>
                </div>
                <div class="flex flex-col mx-auto py-2">
        ...
        <div class="flex justify-between mt-4">
            ...
            <button id="disableButton" data-modal-target="disableModal" data-modal-toggle="disableModal" class="w-full flex items-center justify-center bg-white border border-red-800 
            rounded-lg px-4 py-2 hover:bg-red-200 mx-2
            focus:ring-4 focus:outline-none focus:ring-white dark:bg-green-700 dark:hover:bg-red-200 
            dark:focus:ring-red-800" type="button">
